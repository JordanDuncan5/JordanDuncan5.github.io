...
//function fetchGradeData() {
    //This function will query the PostgreSQL data and return grade data
    //console.log("fetching grade data...");
//}

//TODO: Populate the table with grade data
//function populateGradebook(data) {
    //This function will take the grade data and populate the table
...
function populateGradebook(data) {
    // This function will take the fetched grade data and poopulate the table
    console.log("Populating gradebook with data:", data);
